...
class CreateNewNoteViewModel
  ...
  Future<void> _createNote() async {
    controller.titleAndDescriptionBloc.add(const ResponseEvent.loading());
    log(catalogId.toString());
    final result = await controller.createNote(catalogId: catalogId);
    controller.titleAndDescriptionBloc.add(ResponseEvent.fetch(result: result));
